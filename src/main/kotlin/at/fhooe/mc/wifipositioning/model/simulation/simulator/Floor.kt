...
class Floor {
    ...
    var accessPointList: MutableList<ScannedAccessPoint>? = null
    ...
    constructor(name: String, offsetLeft: Double, offsetRight: Double, offsetTop: Double, offsetBottom: Double, floorWidth: Double, floorHeight: Double, accessPointList: MutableList<ScannedAccessPoint>, floorImage: BufferedImage) {
        this.name = name
    ...
    constructor(name: String, floorBounds: FloorBounds, accessPointList: MutableList<ScannedAccessPoint>, floorImage: BufferedImage) {
        this.name = name
    ...
    fun getAccessPoint(index: Int): ScannedAccessPoint {
